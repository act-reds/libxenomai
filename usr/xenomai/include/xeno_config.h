...
/* config */
#define CONFIG_XENO_BUILD_ARGS " 'CFLAGS=-march=armv7-a -mfpu=vfp3' 'LDFLAGS=-march=armv7-a -mfpu=vfp3' '--host=arm-buildroot-linux-gnueabihf' '--with-core=cobalt' '--enable-smp' 'host_alias=arm-buildroot-linux-gnueabihf'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "collect2: error: ld returned 1 exit status"
...
/* Host system alias */
#define CONFIG_XENO_HOST_STRING "arm-buildroot-linux-gnueabihf"
...
/* config */
#define CONFIG_XENO_VERSION_STRING "3.1.4"
...
#define PACKAGE_STRING "Xenomai 3.1.4"
